...
from brain.essentials.enumerations import MongoCollections
from brain.essentials.core.console import ConsoleManager
...
def configure_MongoDB(db, settings):
    ...
    from brain.essentials.skills.registry import CONTROL_SKILLS, ENABLED_BASIC_SKILLS
